    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 12, 14, 13, 3, 48, 621, DateTimeKind.Utc).AddTicks(7183), "Sistem yöneticisi", "Admin" },
                    { 2, new DateTime(2025, 12, 14, 13, 3, 48, 621, DateTimeKind.Utc).AddTicks(7194), "Standart kullanıcı", "User" },
                    { 3, new DateTime(2025, 12, 14, 13, 3, 48, 621, DateTimeKind.Utc).AddTicks(7196), "Moderatör", "Moderator" }
                });
